...
/**
 * trainMathMastery — Historical Statistics and Topic Recommendation Model
 ...
 */
export function trainMathMastery(masteryData: Record<string, MasteryEntry>): MLReport {
 ...
 */
export function getWeightedTopicList(
  difficulty: 'easy' | 'medium' | 'hard',
  masteryData: Record<string, MasteryEntry>,
): Array<{ topic: string; weight: number }> {
  const report = trainMathMastery(masteryData);
